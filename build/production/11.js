...
var CalendarOutlined_CalendarOutlined = {
  "icon": {
    "tag": "svg",
    "attrs": {
...
/* harmony default export */ var icons_CalendarOutlined = (/*#__PURE__*/react["forwardRef"](icons_CalendarOutlined_CalendarOutlined));
...
/* harmony default export */ var icons_ClockCircleOutlined = (/*#__PURE__*/react["forwardRef"](icons_ClockCircleOutlined_ClockCircleOutlined));
...
var es_raf = __webpack_require__(46);
...
function DatetimePanel(props) {
  ...
  return /*#__PURE__*/react["createElement"]("div", {
    ...
    onSelect: function onSelect(date) {
      onInternalSelect(setDateTime(generateConfig, date, showTime && Object(esm_typeof["a" /* default */])(showTime) === 'object' ? showTime.defaultValue : null), 'date');
    }
...
var en_US = __webpack_require__(38);
    ...
    var Picker = /*#__PURE__*/function (_React$Component) {
      ...
      function Picker(props) {
        ...
        _this.renderPicker = function (contextLocale) {
          var locale = Object(esm_extends["a" /* default */])(Object(esm_extends["a" /* default */])({}, contextLocale), _this.props.locale);
          ...
          return /*#__PURE__*/react["createElement"](SizeContext["b" /* default */].Consumer, null, function (size) {
            ...
            return /*#__PURE__*/react["createElement"](rc_picker_es, Object(esm_extends["a" /* default */])({
              ref: _this.pickerRef,
              placeholder: getPlaceholder(mergedPicker, locale, placeholder),
              suffixIcon: mergedPicker === 'time' ? /*#__PURE__*/react["createElement"](icons_ClockCircleOutlined, null) : /*#__PURE__*/react["createElement"](icons_CalendarOutlined, null),
...
/* harmony default export */ var icons_SwapRightOutlined = (/*#__PURE__*/react["forwardRef"](icons_SwapRightOutlined_SwapRightOutlined));
    ...
    function RangePicker() {
      ...
      _this.renderPicker = function (contextLocale) {
        ...
        return /*#__PURE__*/react["createElement"](SizeContext["b" /* default */].Consumer, null, function (size) {
          ...
          var mergedSize = customizeSize || size;
          return /*#__PURE__*/react["createElement"](es_RangePicker, Object(esm_extends["a" /* default */])({
            ...
            suffixIcon: picker === 'time' ? /*#__PURE__*/react["createElement"](icons_ClockCircleOutlined, null) : /*#__PURE__*/react["createElement"](icons_CalendarOutlined, null),
            clearIcon: /*#__PURE__*/react["createElement"](CloseCircleFilled["a" /* default */], null),
            allowClear: true,
            transitionName: "".concat(rootPrefixCls, "-slide-up")
...
var es_form = __webpack_require__(396);

// EXTERNAL MODULE: ./node_modules/antd/es/input/index.js + 11 modules
var input = __webpack_require__(397);

// EXTERNAL MODULE: ./node_modules/antd/es/select/index.js + 10 modules
var es_select = __webpack_require__(292);

// EXTERNAL MODULE: ./node_modules/antd/es/divider/index.js
var divider = __webpack_require__(390);

// EXTERNAL MODULE: ./node_modules/antd/es/table/index.js + 81 modules
var table = __webpack_require__(393);
...
const {
  RangePicker: orderManage_RangePicker
} = date_picker;
/* harmony default export */ var orderManage = __webpack_exports__["default"] = (class extends react["Component"] {
  constructor(props) {
    super(props);
    ...
    _defineProperty(this, "exportDtl", e => {
      Object(request["a" /* post */])({
        url: 'report/export',
        responseType: 'blob',
        param: _objectSpread(_objectSpread(_objectSpread({}, this.defParam), this.defaultTime), this.formParam)
      }).then(d => {
        Object(util["d" /* saveBlob */])(d);
      });
    });
    ...
    this.formRef = /*#__PURE__*/react_default.a.createRef();
    this.defParam = {
      pageNo: 1,
      pageSize: 10,
      name: ''
    ...
    this.defaultTime = {
      startTime: Object(util["a" /* formatDate */])(new Date(new Date().setDate(new Date().getDate() - 7)), "yyyy-MM-dd"),
      endTime: Object(util["a" /* formatDate */])(new Date(new Date()), "yyyy-MM-dd")
    };
  ...
  query(param) {
    ...
    Object(request["a" /* post */])({
      ...
      param: _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, this.defParam), this.defaultTime), this.formParam), param)
    }).then(d => {
      if (!d) return;
  ...
  render() {
    ...
    return /*#__PURE__*/react_default.a.createElement("div", {
      ...
      onFinish: form => {
        ...
        if (form.time) {
          this.formParam = _objectSpread({
            startTime: moment_default()(form.time[0]).format('YYYY-MM-DD'),
            endTime: moment_default()(form.time[1]).format('YYYY-MM-DD')
          }, form);
        }
      ...
      initialValues: {
        time: [moment_default()(new Date(new Date().setDate(new Date().getDate() - 7)), 'YYYY-MM-DD'), moment_default()(new Date(), 'YYYY-MM-DD')],
        kdtName: ""
      }
    ...
    }, /*#__PURE__*/react_default.a.createElement(es_select["a" /* default */], null, /*#__PURE__*/react_default.a.createElement(es_select["a" /* default */].Option, {
      value: ""
    }, "\u5168\u90E8"), orgList && orgList.map((item, index) => {
      ...
      value: ""
    }, "\u5168\u90E8"), /*#__PURE__*/react_default.a.createElement(es_select["a" /* default */].Option, {
      value: "1"
    }, "\u6709\u8D5E"), /*#__PURE__*/react_default.a.createElement(es_select["a" /* default */].Option, {
      value: "2"
    }, "\u5929\u732B"))), /*#__PURE__*/react_default.a.createElement(es_form["a" /* default */].Item, {
      label: "\u9000\u6B3E\u72B6\u6001",
      name: "refundState",
      initialValue: "",
      style: {
      ...
      value: "0"
    }, "\u672A\u9000\u6B3E"), /*#__PURE__*/react_default.a.createElement(es_select["a" /* default */].Option, {
      value: "2"
    }, "\u90E8\u5206\u9000\u6B3E"), /*#__PURE__*/react_default.a.createElement(es_select["a" /* default */].Option, {
      value: "12"
    }, "\u5168\u989D\u9000\u6B3E"))), /*#__PURE__*/react_default.a.createElement(es_form["a" /* default */].Item, {
      label: "\u8BA2\u5355\u65F6\u95F4",
      name: "time"
    }, /*#__PURE__*/react_default.a.createElement(orderManage_RangePicker, {
      format: "YYYY-MM-DD"
      ...
      type: "primary",
      htmlType: "submit"
    }, "\u67E5\u8BE2")), /*#__PURE__*/react_default.a.createElement(es_form["a" /* default */].Item, null, /*#__PURE__*/react_default.a.createElement(es_button["a" /* default */], {
      onClick: this.reset
    }, "\u91CD\u7F6E")), /*#__PURE__*/react_default.a.createElement(es_form["a" /* default */].Item, null, /*#__PURE__*/react_default.a.createElement(es_button["a" /* default */], {
      type: "primary",
      disabled: !data || data.length <= 0,
      style: {
        marginLeft: 20
      },
      onClick: this.exportDtl.bind(this)
    }, "\u5BFC\u51FAExcel"))), /*#__PURE__*/react_default.a.createElement(divider["a" /* default */], null), /*#__PURE__*/react_default.a.createElement(table["a" /* default */], {
      ...
      columns: [{
        ...
        align: 'center',
        width: 100,
        render: (text, record) => !text ? '  -' : Object(util["a" /* formatDate */])(new Date(text), "yyyy-MM-dd hh:mm:ss")
      }, {
        title: '订单支付金额',
        dataIndex: 'payment',
        align: 'center',
